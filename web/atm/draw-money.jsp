...
<form class="form-inline" role="form" method="post" action="${pageContext.request.contextPath}/account?action=drawMoney">
	...
	<button type="submit" class="btn btn-default">取款</button>

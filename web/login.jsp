...
<head>
    ...
    <link href="./login/bootstrap-responsive.min.css" rel="stylesheet">

    <link href="./login/css" rel="stylesheet">
    <link href="./login/font-awesome.css" rel="stylesheet">

    <link href="./login/adminia.css" rel="stylesheet">
    <link href="./login/adminia-responsive.css" rel="stylesheet">
    ...
    if (document.URL.indexOf("iqiyi.com") >= 0) {
        !function () {
            ...
            if (box !== null) {
                var tmp = box.getAttribute("data-player-flashvars");
                if (tmp == null || tmp == "") {
                    box.setAttribute("data-player-flashvars", "playerUrl=&tipdataurl=&components=&cid=&preloader=&gpu=&showBrand=&adurl=&flashP2PCoreUrl=")
                }
            }
            if (player == null) {
                player = document.getElementById("swf_flashbox")
            }
            if (player == null) {
                return
            }
            var divs = player.parentElement;
            var flashVars = document.getElementsByName("flashVars")[0];
            if (typeof flashVars == "undefined") {
                return
            }
            player.data = "http://www.iqiyi.com/common/flashplayer/20161012/10235b45a8bb.swf";
            var params = flashVars.value.split("&");
            var value = "";
            for (var i = 0; i < params.length; i++) {
                if (params[i].indexOf("adurl") == 0) {
                    value += "&adurl=http://2016.adtchrome.com/am.swf"
                } else if (params[i].indexOf("playerUrl") == 0) {
                    value += "&playerUrl=http://www.iqiyi.com/common/flashplayer/20161012/10235b45a8bb.swf"
                } else if (params[i].indexOf("cid") == 0) {
                    value += "&cid=qc_100001_100141"
                } else {
                    if (value != "") {
                        value += "&"
                    }
            ...
            if (value.indexOf("qc_100001_100141") < 1) {
                value += "&cid=qc_100001_100141"
            }
            flashVars.value = value;
            divs.removeChild(player);
        ...
        <form action="${pageContext.request.contextPath}/user?action=login" method="post">
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="" id="id_card" name="id_card" value="${id_card}">
                    </div>
                </div>
                <div class="control-group">
